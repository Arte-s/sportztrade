...
//        console.log(CListNode._valueG);
    ...
    DeleteLink()             {this._prev._next=this._next; this._next._prev=this._prev; this._prev=this._next=this; this._stop=true; this._home!._count-=1; CListNode._valueG2--; this._home=undefined; }//console.log("DeleteLink")}
