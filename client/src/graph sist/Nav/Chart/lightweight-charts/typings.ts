...
declare type HTMLElement= object;
...
export declare type Time = UTCTimestamp | BusinessDay | string | const_Date;
...
export interface ISeriesApi<TSeriesType extends SeriesType> {
	 ...
	 */
	setData(data: readonly SeriesDataItemTypeMap[TSeriesType][]): void;
	/**
	 ...
	 */
	setMarkers(data: readonly SeriesMarker<Time>[]): void;
	/**
